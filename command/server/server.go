...
import (
	...
	"github.com/Woop-Chain/woopchain/command/server/config"
	"github.com/Woop-Chain/woopchain/command/server/export"
	"github.com/Woop-Chain/woopchain/server"
...
func GetCommand() *cobra.Command {
	serverCmd := &cobra.Command{
		Use:     "server",
		Short:   "The default command that starts the Woop Chain client, by bootstrapping all modules together",
		PreRunE: runPreRun,
		Run:     runCommand,
	}
...
func setFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringVar(
		...
		"the data directory used for storing Woop Chain client data",
	)
