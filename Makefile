...
build:
	...
	go build -o woopchain -ldflags="\
    	-X 'github.com/Woop-Chain/woopchain/versioning.Version=$(LATEST_VERSION)' \
		-X 'github.com/Woop-Chain/woopchain/versioning.Commit=$(COMMIT_HASH)'\
		-X 'github.com/Woop-Chain/woopchain/versioning.Branch=$(BRANCH)'\
		-X 'github.com/Woop-Chain/woopchain/versioning.BuildTime=$(TIME)'" \
	main.go
...
test-e2e:
	...
	go build -race -o artifacts/woopchain .
	env EDGE_BINARY=${PWD}/artifacts/woopchain go test -v -timeout=30m ./e2e/...
